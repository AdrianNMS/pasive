...
{
    public static Mono<ResponseEntity<Object>> getParameterService(Logger log, IParameterService parameterService, Pasive pasive)
    {
    ...
    public static Mono<ResponseEntity<Object>> FindPasive(Logger log, IParameterService parameterService, IPasiveService pasiveService, String id)
    {
    ...
    public static Mono<ResponseEntity<Object>> FindTypeSequence(Logger log, IParameterService parameterService, IPasiveService pasiveService, String id)
    {
